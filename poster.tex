...
\usepackage[orientation=portrait,size=custom,height=113,width=84.1,scale=1.3,debug]{beamerposter}
...
%            \\
              \begin{columns}
                \column{.5\textwidth}
                  \centering
                  \pgfdeclareimage[height=9cm]{maizeSFS}{SFS_maize_compare}
                  \pgfuseimage{maizeSFS}\\
                  \pgfdeclareimage[height=9cm]{maizeTajima}{BKN_TajimaHist}
                  \pgfuseimage{maizeTajima}
                \column{.5\textwidth}
                  \centering
                  \pgfdeclareimage[height=9cm]{teoSFS}{SFS_teosinte_compare}
                  \pgfuseimage{teoSFS}\\
                  \pgfdeclareimage[height=9cm]{teoTajima}{TIL_TajimaHist}
